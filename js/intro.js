...
function go() {
    ...
    setTimeout(() => { // Called just before back is turned to black
        blackBack();
    }, 850)
    
    setTimeout(() => { // Called when text first starts appearing
        showText();
    }, 1150)
    
    setTimeout(() => { // Called as soon as text as finished printing
